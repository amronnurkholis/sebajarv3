...
<body>
    ...
    <main>
        ...
        <section class="hero" id="beranda">
            ...
            <?php if(!empty($rentalStatus['next_change'])): ?>
                <aside class="hero-rental-status <?php echo e($rentalStatus['is_open'] ? 'is-open' : 'is-closed'); ?>" data-rental-status data-next-change="<?php echo e($rentalStatus['next_change']); ?>" aria-live="polite">
                    <span class="material-symbols-outlined" aria-hidden="true"><?php echo e($rentalStatus['is_open'] ? 'schedule' : 'lock_clock'); ?></span>
                    <span class="hero-rental-copy">
                        <strong>Penyewaan sedang <?php echo e($rentalStatus['is_open'] ? 'dibuka' : 'ditutup'); ?></strong>
                    </span>
                    <strong class="hero-rental-time" data-countdown>--:--:--</strong>
                    <span class="hero-rental-caption"><?php echo e($rentalStatus['is_open'] ? 'Sisa waktu' : 'Dibuka kembali'); ?></span>
                </aside>
            <?php endif; ?>
        </section>
        ...
        <section class="section section-white" id="tentang">
            <div class="container intro-grid">
                ...
                <div class="intro-image reveal">
                    <img src="<?php echo e(asset('images/hero/tari-saman-2.jpg')); ?>"
            ...
            <div class="container">
                <div class="section-heading reveal">
                    ...
                    <div class="section-heading-actions">
                        <a href="<?php echo e(url('/koleksi')); ?>" class="text-link">
                            Lihat Semua
                    ...
                    <?php $__currentLoopData = $costumes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $costume): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <article class="costume-card costume-card-compact reveal">
                            <div class="costume-image">
                                <img src="<?php echo e($costumeImage); ?>"
                                     alt="<?php echo e($costumeCode); ?> — <?php echo e($costumeName); ?>"
                                     loading="lazy">
                                <div class="availability">
                                    <span class="availability-dot"></span>
                                    Tersedia
                                </div>
                                <a href="<?php echo e($costumeDetailUrl); ?>" class="costume-image-detail" aria-label="Lihat detail <?php echo e($costumeName); ?>">
                            ...
                            <div class="costume-body">
                                <span class="costume-code"><?php echo e($costumeCode); ?></span>
                                <h3><?php echo e($costumeName); ?></h3>

                                <a href="<?php echo e($costumeDetailUrl); ?>" class="card-link">
                                    Lihat Detail
                                    <span class="material-symbols-outlined">arrow_forward</span>
                                </a>
                            </div>
                ...
                <div class="center-action">
                    <a href="<?php echo e(url('/koleksi')); ?>" class="btn btn-outline collection-cta">Lihat Semua Koleksi <span class="material-symbols-outlined" aria-hidden="true">arrow_forward</span></a>
                </div>
            </div>
        </section>
        ...
        <section class="section section-white" id="cara-sewa">
            <div class="container how-to-wrap">
                <div class="how-to-copy reveal">
                    ...
                    <a href="<?php echo e(url('/koleksi')); ?>" class="btn btn-primary">
                        Mulai Pilih Kostum
                    </a>
                </div>
        ...
        <section class="section section-ivory">
            <div class="container">
                <div class="support-card reveal">
                    ...
                    <a href="<?php echo e($whatsappUrl); ?>" class="btn btn-primary" target="_blank" rel="noopener">
        ...
        <div class="container footer-grid">
            ...
            <div class="footer-links">
                ...
                <div>
                    ...
                    <a href="<?php echo e(url('/login')); ?>">Daftar</a>
                    <a href="<?php echo e($whatsappUrl); ?>" target="_blank" rel="noopener">Chat Admin</a>
                </div>
            </div>
        </div>
        <div class="container footer-bottom">
            <small>&copy; <?php echo e(date('Y')); ?> Sebajar.id. Semua hak dilindungi.</small>
        </div>
    </footer>

    <script src="<?php echo e(asset('js/sebajar-home.js')); ?>"></script>
</body>
</html>
<?php /**PATH /home/ophelia/Publik/sebajarv3/resources/views/home.blade.php ENDPATH**/ ?>