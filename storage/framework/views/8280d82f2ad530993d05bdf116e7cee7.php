        ...
        <div class="profile-grid">
            <aside class="profile-card">
                ...
                <div>
                    ...
                    <div class="profile-role"><?php echo e($user->role); ?></div>
                </div>
                <div class="profile-stats">
                    <div class="profile-stat"><span>Total pengajuan</span><strong><?php echo e($orderCount); ?></strong></div>
                    <div class="profile-stat"><span>Menunggu</span><strong><?php echo e($pendingCount); ?></strong></div>
                </div>
            </aside>
            ...
            <section class="form-card">
                ...
                <?php if(session('success')): ?>
                    <div class="profile-alert success">✓ <?php echo e(session('success')); ?></div>
                <?php endif; ?>
                <?php if($errors->any()): ?>
                    <div class="profile-alert profile-errors"><ul><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($error); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul></div>
                <?php endif; ?>

                <form method="POST" action="<?php echo e(route('profil.update')); ?>">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="field"><label for="name">Nama pengguna</label><input id="name" name="name" value="<?php echo e(old('name', $user->name)); ?>" autocomplete="name" required></div>
                    ...
                    <div class="actions"><a href="<?php echo e(route('pesanan')); ?>" class="profile-btn secondary">Pesanan Saya</a><button type="submit" class="profile-btn primary">Simpan Perubahan</button></div>
                </form>
            </section>
        </div>
    </div>
...
<?php /**PATH /home/ophelia/Publik/sebajarv3/resources/views/profil.blade.php ENDPATH**/ ?>