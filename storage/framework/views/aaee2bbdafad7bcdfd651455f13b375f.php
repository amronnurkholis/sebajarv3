<?php $__env->startSection('title', 'Kostum'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a
            href="<?php echo e(route('admin.costumes.create')); ?>"
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-4">
        ...
        <form
            method="GET"
            action="<?php echo e(route('admin.costumes.index')); ?>"
                        ...
                        <tr class="transition hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <a
                                        href="<?php echo e(route('admin.costumes.show', $costume)); ?>"
                                    ...
                                    <a
                                        href="<?php echo e(route('admin.costumes.edit', $costume)); ?>"
                                        class="rounded-lg border border-gray-200 px-3 py-2 text-xs font-medium text-gray-600 transition hover:bg-gray-50"
                                    >
                                        Edit
                                    </a>
                                    ...
                                    <form
                                        method="POST"
                                        action="<?php echo e(route('admin.costumes.destroy', $costume)); ?>"
                                        onsubmit="return confirm('Hapus kostum <?php echo e(addslashes($costume->code)); ?> - <?php echo e(addslashes($costume->name)); ?>?
...
Data stok dan gambar upload kostum ini akan ikut dihapus.');"
        ...
        <?php if(method_exists($costumes, 'links')): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ophelia/Publik/sebajarv3/resources/views/admin/costume/index.blade.php ENDPATH**/ ?>