...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/sebajar-logo.png')); ?>">

    <title><?php echo e($costume->code); ?> — <?php echo e($costume->name); ?> | Sebajar.id</title>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .status{
            ...
            padding:8px 11px;
            border-radius:6px;
            background:<?php echo e($status==='Terbatas' ? 'var(--orange-bg)' : 'var(--green-bg)'); ?>;
            color:<?php echo e($status==='Terbatas' ? 'var(--orange)' : 'var(--green)'); ?>;
            font-size:11px;
            font-weight:800
        }
...
<main class="main">
    ...
    <div class="crumb">
        ...
        <span>›</span>
        <a href="<?php echo e(url('/koleksi')); ?>">Koleksi</a>
        <span>›</span>
        <span><?php echo e($costume->code); ?></span>
    </div>
    ...
    <section class="detail">
        ...
        <div class="gallery">
            ...
            <div class="thumbs">
                <?php $__currentLoopData = $galleryUrls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $imageUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button
                        class="thumb <?php echo e($index === 0 ? 'active' : ''); ?>"
                        data-image="<?php echo e($imageUrl); ?>"
                        type="button"
                    >
                        <img
                            src="<?php echo e($imageUrl); ?>"
                            alt="<?php echo e($costume->name); ?> - gambar <?php echo e($index + 1); ?>"
                        >
                    </button>
        ...
        <div>
            ...
            <h1 class="title"><?php echo e($costume->name); ?></h1>

            <div class="code">
                Kode Kostum: <?php echo e($costume->code); ?>
            ...
            <p class="desc">
                ...
                <?php else: ?>
                    ...
                    <strong><?php echo e($costume->name); ?></strong>,
            ...
            <div class="block">
                ...
                <div class="stock-summary">
                    ...
                    <div class="stock-card">
                        ...
                        <div class="stock-card-value"><?php echo e($stockSets); ?> Set</div>
                    ...
                    <div class="stock-card">
                        ...
                        <div class="stock-card-value"><?php echo e($shirtTotal); ?> Pcs</div>
                        <div class="stock-card-note">
                ...
                <div class="color-list">
                    <?php $__currentLoopData = $shirtColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <span class="color-item">
                            <span class="color-dot <?php echo e($colorClass); ?>"></span>
                            <?php echo e($color); ?>
            ...
            <div class="block">
                ...
                <div class="inventory-table">
                    ...
                    <?php $__currentLoopData = $shirtSizes->where('quantity', '>', 0); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="inventory-row">
                            <span><?php echo e($stock->size); ?></span>
                            <span class="inventory-qty">
                                <?php echo e($stock->quantity); ?> pcs
                            </span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="block">
                ...
                <div class="inventory-table">
                    ...
                    <?php $__currentLoopData = $pantsSizes->where('quantity', '>', 0); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="inventory-row">
                            <span><?php echo e($stock->size); ?></span>
                            <span class="inventory-qty">
                                <?php echo e($stock->quantity); ?> pcs
            ...
            <div class="rental">
                ...
                <div class="actions">
                    ...
                    <a
                        class="btn primary"
                        href="<?php echo e(url('/penyewaan?kostum='.rawurlencode($costume->code))); ?>"
                    >
                        Ajukan Penyewaan →
                    </a>
...
<footer class="footer">
    ...
    <div class="footer-in">
        ...
        <div>
            ...
            <div class="footer-links">
                <a href="<?php echo e($whatsappUrl); ?>">Hubungi Admin</a>
                <a href="<?php echo e(url('/#cara-sewa')); ?>">Panduan Penyewaan</a>
...
<?php /**PATH /home/ophelia/Publik/sebajarv3/resources/views/detail-kostum.blade.php ENDPATH**/ ?>