<?php if(session('success') || session('error') || session('warning')): ?>
    ...
    <div class="sebajar-toast-wrap" aria-live="polite" aria-atomic="true">
        <div class="sebajar-toast sebajar-toast-<?php echo e($toastType); ?>" data-toast role="status">
            ...
            <div><strong><?php echo e($toastTitle); ?></strong><p><?php echo e($toastMessage); ?></p></div>
...
<?php /**PATH /home/ophelia/Publik/sebajarv3/resources/views/partials/toast.blade.php ENDPATH**/ ?>