...
<head>
    ...
    <link
        rel="stylesheet"
        href="{{ asset('css/sebajar-home.css') }}"
    >
    ...
    <section class="rental-layout">
        ...
        <aside class="selected-card">
            ...
            <div class="selected-image">
                ...
                <img
                    src="{{ $costume->image_url ?: asset('images/sebajar-logo.png') }}"
            ...
            <div class="selected-content">
                ...
                <div class="selected-code">
                    {{ $costume->code }} · Kostum Tari Saman
                </div>
                    ...
                    <div class="form-group full">
                        ...
                        <div class="size-selection">
                            ...
                            <div class="size-category">
                                ...
                                @else
                                    <div class="size-list">
                                        @foreach ($shirtSizes as $stockSize)
                                            @php
                                            ...
                                            <div class="size-item">
                                                <div>
                                                    <div class="size-name">{{ $sizeValue }}</div>
                                                    <span class="size-stock">Stok {{ $maxValue }} pcs</span>
                                                </div>
                                                ...
                                                <div class="size-control">
                                                    <button
                                                        ...
                                                        data-target="baju-{{ md5($sizeValue) }}"
                                                        aria-label="Kurangi baju ukuran {{ $sizeValue }}"
                                                    >−</button>

                                                    <input
                                                        class="size-input size-quantity"
                                                        type="number"
                                                        id="baju-{{ md5($sizeValue) }}"
                                                        name="baju[{{ $sizeValue }}]"
                                                        value="{{ min($oldValue, $maxValue) }}"
                                                        min="0"
                                                        max="{{ $maxValue }}"
                                                        data-category="baju"
                                                        data-size="{{ $sizeValue }}"
                                                    ...
                                                    <button
                                                        ...
                                                        data-target="baju-{{ md5($sizeValue) }}"
                                                        aria-label="Tambah baju ukuran {{ $sizeValue }}"
                                                    >+</button>
                                                </div>
                                            </div>
                                        @endforeach
                                            ...
                                            <div class="size-item">
                                                ...
                                                <div class="size-control">
                                                    <button
                                                        ...
                                                        class="size-button"
                                                        data-size-action="minus"
                                                        data-target="celana-{{ md5($sizeValue) }}"
                                                        aria-label="Kurangi celana ukuran {{ $sizeValue }}"
                                                    >−</button>

                                                    <input
                                                        class="size-input size-quantity"
                                                        type="number"
                                                        id="celana-{{ md5($sizeValue) }}"
                                                        name="celana[{{ $sizeValue }}]"
                                                        value="{{ min($oldValue, $maxValue) }}"
                                                        min="0"
                                                        max="{{ $maxValue }}"
                                                    ...
                                                    <button
                                                        ...
                                                        data-size-action="plus"
                                                        data-target="celana-{{ md5($sizeValue) }}"
                                                        aria-label="Tambah celana ukuran {{ $sizeValue }}"
                                                    >+</button>
                                                </div>
                                            </div>
                                        @endforeach
